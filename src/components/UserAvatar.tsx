...
export default function UserAvatar({ config, className, pose = "portrait", size = "md" }: UserAvatarProps) {
  ...
  if (pose === "cheering") {
    ...
    armLeft = <path d="M25,85 L10,75" stroke={config.skinTone} strokeWidth="8" strokeLinecap="round"/>;
    armRight = <path d="M75,85 L90,75" stroke={config.skinTone} strokeWidth="8" strokeLinecap="round"/>;
    heldItem = (
      <g>
    ...
    armRight = <path d="M75,85 L95,50" stroke={config.skinTone} strokeWidth="8" strokeLinecap="round"/>;
    heldItem = (
      <g>
        <path d="M95,50 L100,40" stroke={config.skinTone} strokeWidth="4" strokeLinecap="round"/>
        <circle cx="100" cy="40" r="2" fill={config.skinTone} />
      </g>
    );
    ...
    heldItem = (
      <g>
        <circle cx="40" cy="95" r="3" fill={config.skinTone} />
        <circle cx="60" cy="95" r="3" fill={config.skinTone} />
      </g>
    );
  } else if (pose === "taking_photo") {
    armLeft = <path d="M25,85 L40,65" stroke={config.skinTone} strokeWidth="8" strokeLinecap="round"/>;
    armRight = <path d="M75,85 L60,65" stroke={config.skinTone} strokeWidth="8" strokeLinecap="round"/>;
    heldItem = (
      <g>
        <rect x="35" y="55" width="30" height="20" rx="2" fill="#1F2937" />
          ...
          <g transform={headTransform}>
            ...
            {config.accessories === "cap" && (
               <g>
                 ...
                 <path d="M25,35 L15,38 Q50,45 85,38 L75,35" fill={accColor} opacity="0.8" />
               </g>
            )}
            {config.accessories === "beanie" && (
               <g>
                 ...
                 <rect x="28" y="38" width="44" height="4" rx="1" fill={accColor} stroke="rgba(0,0,0,0.1)" strokeWidth="0.5" />
               </g>
            )}
            {config.accessories === "sunglasses" && (
               <g>
                 <path d="M32,48 L48,48 L48,55 Q40,60 32,55 Z" fill={accColor} stroke="#1F2937" strokeWidth="0.5" />
                 <path d="M52,48 L68,48 L68,55 Q60,60 52,55 Z" fill={accColor} stroke="#1F2937" strokeWidth="0.5" />
            ...
            {config.accessories === "necklace" && (
               <g>
                 ...
                 <circle cx="50" cy="85" r="3" fill={accColor} stroke="#B45309" strokeWidth="0.5" />
               </g>
            )}
            ...
            {config.accessories === "mask" && (
               <g>
                 ...
                 <path d="M30,55 L25,50" stroke="#D1D5DB" strokeWidth="1" />
                 <path d="M70,55 L75,50" stroke="#D1D5DB" strokeWidth="1" />
               </g>
            )}
